...
const string strMessageMagic = "Nappacoin Signed Message:\n";
...
static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // Nappacoin: 1 days
static const int64 nTargetSpacing = 15; // Nappacoin: 15 second blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal nappacoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Nappacoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xdb12e419b7b939a91925142e434479f0472402782ce0e2a8c2834ccecc3b68f4");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "San Francisco Chronicle 03/10/2014 6.9 quake strikes off Eureka - no tsunami threat";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1394496297; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 0;

        if (fTestNet)
        {
            block.nTime    = 1394496297;
            block.nNonce   = 584237;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x2e9c15326c7beca3866ded574bbd6cb0c758a09c951263522faac21b63bb2809"));
